                        ...
                        <div class="card-body">
                            ...
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control input-rounded" placeholder=" Category Name" name="gallery_category_name">
                                    </div>
                                    <div class="form-group">
                                    <textarea class="form-control" placeholder=" Description" name="gallery_category_description"></textarea>
                                    </div>
